...
class SellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post sells_url, params: { sell: { name: @sell.name, quantity: @sell.quantity, value: @sell.value } }
    end
  ...
  test "should update sell" do
    patch sell_url(@sell), params: { sell: { name: @sell.name, quantity: @sell.quantity, value: @sell.value } }
